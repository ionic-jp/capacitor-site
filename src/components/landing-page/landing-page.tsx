              ...
              <Col md={6} sm={6} xs={6} cols={12}>
                <hgroup class="hero__heading">
                  ...
                  <Heading level={3}>
                    ...
                    iOS、Android、ウェブを横断して同じコードで一つのアプリを
                    走らせることができます。
                  </Heading>
          ...
          <section class="section--web-apps-to-native">
            <hgroup>
              <Heading id="webapps" level={3}>
                Webアプリを
                <br />
                <FancyUnderline>ネイティブ機能に接続</FancyUnderline>
              </Heading>
            </hgroup>
            <Grid>
              <Col md={4} sm={4} xs={12} cols={12}>
                <img
                  ...
                  alt="Universal apps"
                />
                <Heading level={4}>ユニバーサルアプリ</Heading>
                <Paragraph>
                iOS、Android、およびProgressive Web Appsで同じように動作する
                Webベースのアプリケーションを構築します。
                </Paragraph>
              </Col>
              <Col md={4} sm={4} xs={12} cols={12}>
                <img
                  ...
                  alt="Native access"
                />
                <Heading level={4}>ネイティブアクセス</Heading>
                <Paragraph>
                各プラットフォームで完全なネイティブSDKにアクセスし、
                アプリストア（およびWeb）に簡単にデプロイします。
                </Paragraph>
              </Col>
              <Col md={4} sm={4} xs={12} cols={12}>
                <img
                  ...
                  alt="Native PWAs"
                />
                <Heading level={4}>ネイティブPWA</Heading>
                <Paragraph>
                簡単に利用できるプラグインAPIでカスタムのネイティブ機能を追加するか、
                既存のCordovaプラグインを互換性レイヤーで使用します。
                </Paragraph>
              </Col>
            </Grid>
          </section>
          ...
          <section class="section--your-framework">
            <hgroup>
              <Heading level={3}>
                自分で選んだ
                <br />
                <FancyUnderline>フレームワーク</FancyUnderline>
              </Heading>
              <Paragraph>
              Capacitorを既存のWebアプリプロジェクト、フレームワーク、またはライブラリに導入します。
              既存のReact、Angular、Svelte、Vue（またはお好みのWebフレームワーク）プロジェクトを
              ネイティブモバイルに変換し、
              任意のUIライブラリを使うことができます。
              </Paragraph>
            </hgroup>
            <Grid>
              {[
...
const MetaHead = () => (
  <Helmet>
    ...
    <meta
      name="twitter:image"
      content="https://capacitorjs.jp/assets/img/og.png"
    />
    <meta
      property="og:image"
      content="https://capacitorjs.jp/assets/img/og.png"
