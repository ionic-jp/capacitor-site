              ...
              <Col md={6} sm={8} xs={12} cols={12}>
                <div class="routes-group">
                  <div>
                    ...
                    <ul class="routes">
                      <li><a class="ui-paragraph-4" href="/docs/getting-started">インストール</a></li>
                      <li><a class="ui-paragraph-4" href="/docs">ドキュメント</a></li>
                      <li><a class="ui-paragraph-4" href="/docs/apis">プラグイン</a></li>
                    </ul>
                  </div>
                  <div>
                    <Heading level={5}>Resources</Heading>
                    <ul class="routes">
                      <li><a class="ui-paragraph-4" href="/community">コミュニティ</a></li>
                      <li><a class="ui-paragraph-4" href="/blog">ブログ</a></li>
                      <li><a class="ui-paragraph-4" href="https://github.com/ionic-team/capacitor/discussions">ディスカッション</a></li>
                    </ul>
                  </div>
                  <div>
